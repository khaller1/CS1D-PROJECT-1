...
public:
    ...
    {
        MenuView->setWindowTitle(QApplication::translate("MenuView", "Dialog", Q_NULLPTR));
        ViewMenu->setText(QApplication::translate("MenuView", "View Menu", Q_NULLPTR));
        pushButton->setText(QApplication::translate("MenuView", "Close", Q_NULLPTR));
    } // retranslateUi
