...
const QMetaObject cartTable::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_cartTable.data,
      qt_meta_data_cartTable,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cartTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cartTable.stringdata0))
        return static_cast<void*>(const_cast< cartTable*>(this));
