...
public:
    ...
    {
        TripView->setWindowTitle(QApplication::translate("TripView", "MainWindow", Q_NULLPTR));
        pushButton->setText(QApplication::translate("TripView", "Next Restaurant", Q_NULLPTR));
        label->setText(QApplication::translate("TripView", "Total: ", Q_NULLPTR));
        Total_Label->setText(QString());
        Cart_Button->setText(QApplication::translate("TripView", "Add To Cart", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(Menu_Tab), QApplication::translate("TripView", "Menu", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(Cart_Tab), QApplication::translate("TripView", "Cart", Q_NULLPTR));
    } // retranslateUi
