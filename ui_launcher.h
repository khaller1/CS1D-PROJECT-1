...
public:
    ...
    {
        Launcher->setWindowTitle(QApplication::translate("Launcher", "Launcher", Q_NULLPTR));
        ViewRestaurant_Button->setText(QApplication::translate("Launcher", "View Restaurant's", Q_NULLPTR));
        ViewMenu_Button->setText(QApplication::translate("Launcher", "View Menu's", Q_NULLPTR));
        QuickTrip_Button->setText(QApplication::translate("Launcher", "Quick Trip", Q_NULLPTR));
        CustomTrip_Button->setText(QApplication::translate("Launcher", "Custom Trip", Q_NULLPTR));
        AdminLogin_Button->setText(QApplication::translate("Launcher", "Admin Login", Q_NULLPTR));
        Exit_Button->setText(QApplication::translate("Launcher", "Exit", Q_NULLPTR));
    } // retranslateUi
